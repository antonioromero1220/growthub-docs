...
export const SITE_CONFIG = {
  ...
  ogImage: "/gh-1.png",
  twitterImage: "/gh-2.jpg",
  socialImage: "/gh-1.png",
...
export const PAGE_SEO_CONFIG: Record<string, PageSEO> = {
  ...
  "/integrations/gohighlevel/social-posting": {
    ...
    description:
      "Seamlessly schedule AI-generated content from Growthub to GoHighLevel with Brand Kit consistency.",
    path: "/integrations/gohighlevel/social-posting",
    keywords: ["Social Posting", "GoHighLevel", "social media automation", "AI scheduling"],
  },
